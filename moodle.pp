...
exec { 'install_moodle':
  ...
  command   => "php install.php --chmod=0750 --lang=el --wwwroot=$moodle_root --dataroot=$data_root --dbuser=moodle --dbpass='$moodle_db_pwd' --fullname='$moodle_fullname' --shortname='$moodle_shortname' --non-interactive --agree-license --adminpass='$moodle_adminpass'",
  user      => 'www-data',
}
